(function($){
    var default_options = {
        ...
        templateFile: '<div id="fileup-[INPUT_ID]-[FILE_NUM]" class="fileup-file [TYPE]">' +
            ...
            '<span class="fileup-remove" onclick="$.fileup(\'[INPUT_ID]\', \'remove\', \'[FILE_NUM]\');" title="[REMOVE]"><svg><use xlink:href="#x"></use></svg></span>' +
            '</div>' +
    ...
    var i18n = {
        ...
        fa: {
            ...
            complete: 'تکمیل شد',
            error: 'خطا',
            errorFilesLimit: 'حداکثر %filesLimit% فایل می‌توانید برای بارگذاری انتخاب کنید',
            errorSizeLimit: 'حجم فایل "%fileName%" بیش از حد مجاز می‌باشد (%sizeLimit%)',
            errorFileType: 'نوع فایل "%fileName%" غیرمجاز می‌باشد',
            errorOldBrowser: 'مرورگر شما قابلیت پشتیبانی از بارگذاری فایل را ندارد، لطفا از مرورگرهای بروز استفاده کنید.'
        },
    };
